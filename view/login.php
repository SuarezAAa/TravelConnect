...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>Travel connect - VoyageGlobal</title>
                        ...
                        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    ...
                                    <h1 class="h3 font-w700 mt-30 mb-10">Bienvenido a su panel de control</h1>
                                    <h2 class="h5 font-w400 text-muted mb-0">Inicio sesión</h2>
                                </div>


                                <form class="js-validation-signin px-30" action="index.php?c=Login&a=Agente" method="post">
