    ...
    <div class="row">
      <div class="col-xl-12">
        ...
        <div class="block block-themed">
            ...
            <form class="js-validation-bootstrap" action="index.php?c=Vuelo&a=register_vuelo" method="post">
            ...
            <?php foreach ($aerolinea as $ae) {
             ?>
            <option value="<?php echo $ae->aerolinea_id; ?>"><?php echo $ae->nombre;?></option>
            <?php }?>   
          </select>
                    </div>
                </div> 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="num" class="form-control" id="precio_vuelo" name="precio_vuelo" placeholder="Ingrese el precio del vuelo">
                    </div>
                </div>   
